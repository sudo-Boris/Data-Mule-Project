...
/*                                                             */
/*  Generated at 4/11/2021  11:7.26                             */
/***************************************************************/
#ifndef GLOBALS_H
#define GLOBALS_H
...
/* for meta_data [7:5]-reserved
                 [4:3]-MULE_ACK_type
                 [2:0]-Msg_type                 
*/
#define SEARCH              0x00
#define DISCOVERED          0x01
#define ACK                 0x02
#define DATA                0x03
#define MULE_BP             0x04
#define MULE_ACK            0x05
#define FAULT_CRC           0x07
// To use in combination with MULE_ACK
#define IN_ARCHIVE          0x08
// To use with MULE_BP
#define BP_DONE             0x10
#define SYNC_READY          0x18
#define MSG_TYPE(u)         (u & 0x07)        
#define MULE_TYPE(u)        (u & 0x18)


// payload u + addr + meta_data + src
#define TOTAL_SIZE(u)      (u + 3)
#define PAYLOAD_SIZE(u)    (u - 3)

// Check CRC
#define CHECK_CRC(u)       (u & 0x80)
...
extern int spectrum[3]; // = {850, 870, 900}; 

/*
        Reciever
*/
extern REG_TYPE RegSettings[MAX_REG];
extern REG_TYPE ExtRegSettings[MAX_EXT_REG];

/*
        Transmitter
*/
extern REG_TYPE RegSettingsTX[MAX_REG];
extern REG_TYPE ExtRegSettingsTX[MAX_EXT_REG];
